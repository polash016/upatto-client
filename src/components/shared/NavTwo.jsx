...
export default function NavTwo({ isScrolled }) {
  const [isOpen, setIsOpen] = useState(false);
  const menuItems = [
    { label: "HOME", position: { top: "30%", left: "35%" } },
    { label: "PROJECTS", position: { top: "40%", left: "43%" } },
    { label: "MEDIA", position: { top: "48%", left: "72%" } },
    { label: "ABOUT US", position: { top: "60%", left: "58%" } },
  ];
